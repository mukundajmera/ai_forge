...
import { useJobs, useActiveModel, useSystemStatus, useKeyboardShortcut } from '@/lib/hooks'
import { NewFineTuneDialog } from '@/features/jobs/components/NewFineTuneDialog'
...
export function DashboardPage() {
  ...
  // Keyboard shortcut: Cmd+N to open new fine-tune dialog
        ...
        <div className="dashboard-grid">
          ...
          <div className="quick-actions">
            ...
            <div className="actions-grid">
              <button onClick={() => setShowNewDialog(true)} className="action-card primary">
                <Plus size={24} />
